...
public class Scene1 : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("1", "1", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=black", 80);
			
			text1 = add_sprite_for_text("Home", "myfont");
		    scene1 = add_sprite_for_image(SEImage.for_resource("1"));
			text = add_sprite_for_text("Fizz", "myfont");

			text1.move(100,600);
		    scene1.move(get_scene_width()*0.5,0);
			text.move(100,100);
	}
