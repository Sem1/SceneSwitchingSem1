...
public class Scene2 : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("2", "2", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=black", 80);
			
			text1 = add_sprite_for_text("Home", "myfont");
		    scene2 = add_sprite_for_image(SEImage.for_resource("2"));
			text = add_sprite_for_text("Zed", "myfont");

			text1.move(100,600);
		    scene2.move(get_scene_width()*0.5,0);
			text.move(100,100);
	}
